...
<body id="index">
    ...
    <div class="w-content m-center">
       <form action="${ctx }/topic/saveQuestion" method="post" id="inputForm">
        <input type="hidden" name="type" value="3"/>
         <div class="content">
             ...
             <div class="control">
               <label style="float:left;">问题描述:</label>
             ...
             <div class="operation">
                 <input type="button" id="saveBtn" value="确认提问 "/>
             </div>
         </div>
         </form>
    </div>
		   ...
		   $("#content").val(ue.getContent());
		    ...
		    $.ajax({  
                    ...
                    success : function(result) {//返回数据根据结果进行相应的处理  
                        if (result=="success") {  
                            alert("提问成功");
                            window.location.href="${ctx}/topic/hotQuestions.html"
                        } else {  
                            alert(result);
                        }  
                    }  
