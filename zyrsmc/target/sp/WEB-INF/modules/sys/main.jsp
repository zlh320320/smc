...
<head>
 ...
 <%@include file="/WEB-INF/modules/sys/common.jsp"  %>
    <title>YOUR87互联 后台管理</title>
    <meta name="keywords" content="需求,能力,江西关系,上饶,资源">
    <meta name="description" content="需求能力关系资源管理">
    <!--[if lt IE 8]>
    <script>
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element" style="text-align:center;">
                            <span><img alt="image" style="width:60px;" class="img-circle" src="${ctx}/${user.avatar ==null||user.avatar ==''?'static/front/images/default_avatar.png':user.avatar }" /></span>
                    ...
                    <c:forEach items="${fns:getMenus() }" var="menu">
					    <c:if test="${'0' eq menu.parentId}">
					       <c:if test="${'0' eq menu.hasMessage ||menu.hasMessage ==''||menu.hasMessage==null}">
						      <li>
						      <c:if test="${menu.isLeaf eq '0'}">
		                        ...
		                        <ul class="nav nav-second-level"> 
		                        		<c:forEach items="${fns:getMenus() }" var="menu2">
							               <c:if test="${menu2.parentId eq menu.menuId }">
							                   <li>
		                              		  <a class="J_menuItem" href="${ctx }/${menu2.href }" data-index="0">${menu2.menuName }</a>
		                           			 </li>
							               </c:if>
							          </c:forEach>
		                        </ul>
	                    	...
	                    	<c:if test="${menu.hasMessage eq '1'}">
	                    	<li>
	                    	    <c:if test="${menu.isLeaf eq '0'}">
		                        <a class="J_menuItem" href="${ctx }${menu.href }">
		                            <i class="fa fa-home"></i>
		                        ...
		                        <ul class="nav nav-second-level">
		                        		<c:forEach items="${fns:getMenus() }" var="menu2">
							               <c:if test="${menu2.parentId eq menu.id }">
							                   <li>
		                              		  <a class="J_menuItem" href="${ctx }/${menu2.href }" data-index="0">${menu2.menuName }</a>
		                           			 </li>
							               </c:if>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="$(ctx)/main">首页</a>
                    </div>
                </nav>
                ...
                <a href="${ctx }/logout" class="roll-nav roll-right J_tabExit"><i class="fa fa-power-off"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx }/user/getUser?userId=1" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
