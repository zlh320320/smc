...
<body class="signin">
    <div class="signinpanel">
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <div class="m-b"></div>
                    <h4>欢迎使用 <strong>个人网络信息系统</strong></h4>
                    <ul class="m-b">
            ...
            <div class="col-sm-5">
                <form method="post" action="${ctx }/sys/login">
                    ...
                    <p class="m-t-md">登录到个人网络信息系统</p>
                    <input type="text" class="form-control uname" style="color: black;" placeholder="用户名" name="username"/>
                    <input type="password" class="form-control pword m-b" style="color: black;" placeholder="密码" name="password"/>
                    <a href="">忘记密码了？</a>
        ...
        <div class="signup-footer">
            <div class="pull-left">
                &copy; 2015 All Rights Reserved. 版权所有	
            </div>
        </div>
    </div>
</body>
