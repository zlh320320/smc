...
<body id="index">
    ...
    <div class="w-content m-center">
        <div class="con-right fl" style="width:100%;">
            ...
            <div class="ztz">
                <a href="${ctx}/topic/getTopic/-1.html" style="margin-top:10px;height:30px;margin-left:20px;color:blue;">发表新帖</a>
                <div class="page">
                ...
                <c:forEach items="${topicList}" var="topic" varStatus="vs">
	                <tr class="qsg" >
	                     <td class="title" style="font-size: 18px;"><c:if test="${vs.index<2 }"><span style="color:red;">New</span></c:if><a href="${ctx}/topic/detail/${topic.id}.html">${topic.title }</a></td>
	                     <td>${topic.editor}	</td>
