...
<body class="gray-bg">
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <p id="pay-qrcode">
                            <a href="javascript:;"><img src="http://cdn.zi-han.net/theme/hplus/pay.png" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                            </a>
                        </p>
    ...
    <script id="welcome-template" type="text/x-handlebars-template">
        <div class="border-bottom white-bg page-heading clearfix">
            <h2>更新日志：</h2>
            <div>今天是情人节，H+终于跨到了v3.0，就算是情人节礼物吧，感谢你们的不离不弃，一路相伴！
                <br>v3版侧重于较大屏幕(PC+Pad)的展示，如果项目侧重于手机端显示，建议使用H+的<a href="http://www.zi-han.net/theme/hplus/v2" target="_blank">v2.2版本</a>。</div>
